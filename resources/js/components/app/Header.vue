...
import { useSignStore } from '@/stores/backend/sign.js'
...
function logout() {
	signStore.fetchLogout().then((response) => {
        Swal.fire({
            title: '登出成功',
            icon: 'success',
	...
	<div id="header" class="app-header" v-bind:class="{ 'app-header-inverse': appOption.appHeaderInverse }">
		...
		<div class="navbar-header">
			...
			<RouterLink to="/" class="navbar-brand">
				<span class="navbar-logo"></span> <b>袋鼠購物趣</b>
			</RouterLink>
		...
		<div class="navbar-nav">
			...
			<div class="navbar-item navbar-user dropdown">
				<a href="#" class="navbar-link dropdown-toggle d-flex align-items-center" data-bs-toggle="dropdown">
					...
					<span>
						<span class="d-none d-md-inline">歡迎回來 </span>
						<b class="caret"></b>
					</span>
				</a>
