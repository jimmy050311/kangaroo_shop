            ...
            <div class="modal-content">
                ...
                <div class="modal-body form-group">
                    <div class="row mt-1">
                        ...
                        <div class="col-md-9">
                            <input class="form-control" type="password" v-model="userData.password" placeholder="請輸入密碼" autocomplete="off" style="width: 100%;">
                        </div>
                    </div>
                    <div class="row mt-1">
                        <div class="col-md-3">
                        ...
                        <div class="col-md-9">
                            <input class="form-control" type="password" v-model="userData.password_confirmation" placeholder="請輸入確認密碼" autocomplete="off" style="width: 100%;">
                        </div>
                    </div>
...
<script setup>
    ...
    function submit() {
        ...
        userStore.fetchEditUser(props.id, data)
        hideModal()
    }
