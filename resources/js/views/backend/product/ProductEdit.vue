    ...
    <div class="tab-content panel rounded-0 p-3 m-0">
        ...
        <div class="tab-pane fade" id="default-tab-3">
            ...
            <div class="mt-3 col-md-12 d-flex justify-content-center">
                <button type="submit" class="col-md-6 btn btn-primary w-100px" @click="submit()">修改商品</button>
            </div>
        </div>
    </div>    
</template>
<script setup>
    ...
    onMounted(async() => {
        ...
        await productStore.fetchProductDetail(productId.value).then((response) => {
            ...
            productData.rate = response.rate
            productData.profit = response.profit
            productData.origin_price_aud = response.origin_price_aud
            productData.real_price_aud = response.real_price_aud
            productData.origin_price_twd = response.origin_price_twd
            productData.real_price_twd = response.real_price_twd
            ...
            response.img_data.forEach(item => {
