...
<div class="section section-padding-02">
    <div class="container">
        ...
        <div class="history-icon text-center">
            <img src="/assets2/images/icon/icon-5.jpg" alt="Icon">
        </div>
        <!-- History Icon End -->
        ...
        <div class="row">
            <div class="col-lg-8">
                ...
                <div class="image-gallery">
                    <img src="/assets2/images/images-gallery/image-1.jpg" alt="gallery">
                </div>
                <!-- Image Gallery End -->
            </div>
            <div class="col-lg-4">
                <!-- Image Gallery Start -->
                <div class="image-gallery">
                    <img src="/assets2/images/images-gallery/image-2.jpg" alt="gallery">
                </div>
                <!-- Image Gallery End -->
            </div>
            <div class="col-lg-6">
                <!-- Image Gallery Start -->
                <div class="image-gallery">
                    <img src="/assets2/images/images-gallery/image-3.jpg" alt="gallery">
                </div>
                <!-- Image Gallery End -->
            </div>
            <div class="col-lg-6">
                <!-- Image Gallery Start -->
                <div class="image-gallery">
                    <img src="/assets2/images/images-gallery/image-4.jpg" alt="gallery">
                </div>
                <!-- Image Gallery End -->
            </div>
        </div>
            ...
            <div class="swiper-container">
                <div class="swiper-wrapper">
                    ...
                    <div class="single-testimonial swiper-slide">
                        <img class="quote" src="/assets2/images/icon/quote.png" alt="Icon">
                        ...
                        <img class="author-thumb" src="/assets2/images/author-1.jpg" alt="Author">
         ...
         <div class="team-wrapper">
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="single-team">
                        <div class="team-images">
                            <img src="/assets2/images/team/team-1.jpg" alt="Team">
                        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="single-team">
                        <div class="team-images">
                            <img src="/assets2/images/team/team-2.jpg" alt="Team">
                        </div>
                        <div class="team-content">
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="single-team">
                        <div class="team-images">
                            <img src="/assets2/images/team/team-3.jpg" alt="Team">
                        </div>
                        <div class="team-content">
